...
export default function LandingPage() {
  ...
  const audioUrls = useMemo(
    () =>
      flashcards
        .filter((c) => (c as any).type === "audio" && typeof (c as any).audioUrl === "string")
        .map((c) => (c as any).audioUrl as string),
    [flashcards]
  );
  ...
  const handleComplete = () => {
    ...
    try {
      ...
      localStorage.setItem(
        "planProgress",
        JSON.stringify({ discover: "completed", train: "completed", execute: "available" })
      );
    }
    ...
    <div className="absolute inset-0 flex items-center justify-center ">
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "inset 0 1px 0 rgba(255,255,255,0.02), 0 12px 40px rgba(0,0,0,0.6)",
        }}
      >
        <div
          ...
          >
            {!showFlashcards && (
              <div className="w-full h-[320px] relative">
                <Image src="/Train.jpg" alt="Train" fill style={{ objectFit: "cover" }} priority />
              </div>
            )}

            {showFlashcards && (
              <div className="min-h-screen max-w-md relative overflow-hidden" style={{ minHeight: 0 }}>
                <div className="absolute inset-0">
                  {[...flashcards, {id: 'static-bg', backgroundImage: '/Train.jpg'}].map((card) => {
                ...
                <div className="z-10">
                  <div className="h-screen flex flex-col" style={{ minHeight: 320 }}>
                    <Flashcards
        ...
        {!showFlashcards && (
          <div className="w-full flex-1 pt-4">
            ...
            <p className="text-[15px] text-white/70 leading-relaxed mb-6">
              Confidence can take a hit after a mistake or poor performance. That drop you experience
              is normal. What matters is how you respond.
            </p>
